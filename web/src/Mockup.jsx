 ...
 * W / FA kind, and the manager's fantasy-team crest + 3-letter code pinned
 * to the right. */
const WV_SHARE_IN = [
      ...
      <ol className="mockup-wv-share__list">
        {rows.map((r, i) => (
          <li className="mockup-wv-share__row" key={i}>
            ...
            <span className="mockup-wv-share__owner" title={WV_TEAM[r.team]?.name}>
              <WvTeamBadge code={r.team} size={18} />
              <span className="mockup-wv-share__owner-abbr">
                {teamChipAbbr(WV_TEAM[r.team]?.name)}
              </span>
            </span>
          </li>
        ))}
      ...
      <div className="mockup__page">
        ...
        <section className="mockup__section">
          ...
          <p className="mockup__section-sub">
            ...
            position (once) · IN crest + name ← OUT crest + name · and the
            manager's fantasy-team crest + 3-letter code pinned right. Mirrors the data in <code style={{ fontFamily: 'Geist Mono, monospace', fontSize: 12 }}>WaiverSummaryShare</code>.
          </p>
          <div className="mockup-portrait-row mockup-wv-frames">
            <div className="mockup-portrait-col">
