      ...
      <div className="mockup__page">
        ...
        <section className="mockup__section">
          ...
          <p className="mockup__section-sub">
            ...
            position (once) · IN player + club crest ← OUT player · and the
            manager's fantasy-team crest pinned right. Mirrors the data in <code style={{ fontFamily: 'Geist Mono, monospace', fontSize: 12 }}>WaiverSummaryShare</code>.
          </p>
          <div className="mockup-portrait-row mockup-wv-frames">
            <div className="mockup-portrait-col">
