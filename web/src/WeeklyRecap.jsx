...
import { defaultRecapView, defaultModeForGw, recapMenuLabelForStatus } from './weeklyRecapView.js'
 ...
 *
 * Default: looking ahead (live / XIs in) opens Preview; looking back (GW
 * complete) opens Recap. The FPL Live menu label follows that.
 */
...
function PreviewHeader({ preview }) {
  ...
  return (
    <>
      <p className="weekly-recap__note">
        What the model thinks before kick-off — from the starting XI: odds,
        who to watch, injuries that matter, and whether the bench looks off.
      </p>
      <div className="weekly-recap__superlatives">
        {favourite ? (
          <span className="weekly-recap__superlative">
