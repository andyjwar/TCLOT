...
fs.writeFileSync(`${OUT}/header-cards-mobile-all.png`, Buffer.from(shotAll.data, 'base64'));
console.log('wrote header-cards-mobile-all.png');
...
for (const r of result.value) {
  ...
  fs.writeFileSync(`${OUT}/header-cards-mobile-${r.name}.png`, Buffer.from(shot.data, 'base64'));
  console.log('wrote', `header-cards-mobile-${r.name}.png`);
}
