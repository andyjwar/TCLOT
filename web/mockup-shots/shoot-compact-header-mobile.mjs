...
fs.writeFileSync(`${OUT}/compact-header-mobile-all.png`, Buffer.from(shotAll.data, 'base64'));
console.log('wrote compact-header-mobile-all.png');
...
for (const r of result.value) {
  ...
  fs.writeFileSync(`${OUT}/compact-header-mobile-${r.name}.png`, Buffer.from(shot.data, 'base64'));
  console.log('wrote', `compact-header-mobile-${r.name}.png`);
}
